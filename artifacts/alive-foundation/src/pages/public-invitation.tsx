...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    name: "Plan Inclusión",
    price: "RD$ 50,000",
    tagline: "Haciendo visible el cambio · Todo lo del Plan Comunidad +",
    highlights: [
  ...
  },
  {
    ...
    name: "Plan Impacto",
    price: "RD$ 100,000",
    tagline: "Transformando vidas juntos · Todo lo del Plan Inclusión +",
    highlights: [
  ...
  },
  {
    ...
    tagline: "Agua, alimentos, impresión, sonido, mobiliario, transporte, regalos, terapias o fotografía.",
    highlights: [
